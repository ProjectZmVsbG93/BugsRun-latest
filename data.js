...
export const BUG_TEMPLATES = [
    ...
    { id: 'butterfly', name: 'アゲハチョウ', icon: '<img src="butterfly_adult.png" class="bug-img" alt="アゲハチョウ">', speed: 5, hp: 6, attack: 2, type: '進化', skills: ['脱皮する', '葉っぱを食べる'], desc: '幼虫からサナギ、そして成虫へと進化する虫。成虫になると移動力と攻撃力が大幅にアップし、空を飛んで障害物を無視する。大器晩成型のあなたにおすすめ。' },
